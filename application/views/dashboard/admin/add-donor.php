        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h6 style="color: red;"><b>* Required Fields</b></h6>
                </div>
                <div class="card-body">
                    <!-- complete form -->
                    <div id="pay-invoice">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url() ?>Admin/add_donor" method="post" class="form-validate" novalidate>
                                <div class="form-group">
                                    <label for="name" class="control-label mb-1">Full Name <span style="color: red;">*</span></label>
                                ...
                                <div class="form-group">
                                    <label for="telephone">Mobile Phone<span style="color: red;">*</span></label>
